...
class MicrosoftUtilsTest
{
    ...
    {
        assertEquals(18, MicrosoftUtils.KNOWN_CLIENTS.size());
        ...
        assertEquals(2, legacy, "only the Mojang-family clients use the t= ticket prefix");
        ...
        assertTrue(ids.contains("6a3728d6-27a3-4180-99bb-479895b8f88e"), "HMCL client id missing");
    }
}
